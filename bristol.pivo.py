...
PATH = r'Documents\прога питон 1\прога проект парсер\bristol.pivo.csv' #r нужен так как иначе включается экранирование и \b читается как \x08

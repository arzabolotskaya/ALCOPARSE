...
URL = 'https://bristol.ru/catalog/alkogol/igristye_vina/'
...
PATH = r'Documents\прога питон 1\прога проект парсер\bristol.igristye_vina.csv' #r нужен так как иначе включается экранирование и \b читается как \x08

...
URL = 'https://bristol.ru/catalog/alkogol/vina_vinogradnye/'
...
PATH = r'Documents\прога питон 1\прога проект парсер\bristol.vina_vinogradnye.csv' #r нужен так как иначе включается экранирование и \b читается как \x08
